...
<template:insert template='/templates/mainLayout.jsp'> 
  <template:put name='title' content='Billing' direct='true'/> 
  <template:put name='breadcrumb' content='Billing > Overview' direct='true'/> 
  ...
  <template:put name='content' content='/content/billing.jsp'/>
