...
<template:insert template='/templates/mainLayout.jsp'> 
  <template:put name='title' content='Clients' direct='true'/> 
  <template:put name='breadcrumb' content='Clients > Overview' direct='true'/> 
  ...
  <template:put name='content' content='/content/clients.jsp'/>
