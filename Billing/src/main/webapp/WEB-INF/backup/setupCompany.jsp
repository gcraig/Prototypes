...
<template:insert template='/templates/mainLayout.jsp'> 
  <template:put name='title' content='Setup Company' direct='true'/> 
  <template:put name='breadcrumb' content='Billing > Setup > Company' direct='true'/> 
  ...
  <template:put name='content' content='/content/setupCompany.jsp'/> 
