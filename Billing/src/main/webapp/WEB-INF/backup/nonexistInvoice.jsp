...
<template:insert template='/templates/mainLayout.jsp'> 
  <template:put name='title' content='View Invoice' direct='true'/> 
  <template:put name='breadcrumb' content='Billing > Invoices > View Invoice' direct='true'/> 
  ...
  <template:put name='content' content='/content/nonexistInvoice.jsp'/>
