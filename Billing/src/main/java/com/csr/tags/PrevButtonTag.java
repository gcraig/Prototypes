    ...
    throws IOException, ProtocolException, UnknownHostException 
	{
		...
		if (!(prev < 1))
		{
			pageContext.getOut().print(
				"<input type=\"button\" value=\"<<\" class=\"submit3\" onClick=\"location.href='" + href + "?pgPtr=" + 1 + "'\">");

			pageContext.getOut().print("&nbsp;");

			pageContext.getOut().print(
				"<input type=\"button\" value=\"Prev\" class=\"submit3\" onClick=\"location.href='" + href + "?pgPtr=" + prev + "'\">");
		}
